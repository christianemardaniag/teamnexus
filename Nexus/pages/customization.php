    ...
    <div class="container-fluid">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="collapsingNavbar">
        <ul class="navbar-nav">
          ...
          <li class="nav-item pr-4">
            <a class="nav-link active" href="customization.php">Customize</a>
          </li>
          <li class="nav-item pr-4">
            ...
            <div class="row">
              <div class="col-sm-8 overflow-y">
                <div class="card-columns card-columns-2">
                  ...
                  <div class="clearfix"></div>
                  <div class="card">
                    <img class="img-fluid card-img img-hover cursor-pointer" src="../images/templateImages/Animals images/white-tiger-bengal-tiger-wallpaper.jpg" onclick="insertImageToCanvas(this.src)" data-dismiss="modal">
                    <a href="https://free4kwallpapers.com/" class="text-secondary text small ml-2" target="_blank">View Image Source</a>
                  </div>
                  <div class="clearfix"></div>
                  <div class="card">
                    <img class="img-fluid card-img img-hover cursor-pointer" src="../images/templateImages/Galaxy images/moon-4k-ap.jpg" onclick="insertImageToCanvas(this.src)" data-dismiss="modal">
                    <a href="https://free4kwallpapers.com/" class="text-secondary text small ml-2" target="_blank">View Image Source</a>
                  </div>
                  <div class="clearfix"></div>
                  <div class="card">
                    <img class="img-fluid card-img img-hover cursor-pointer" src="../images/templateImages/Movies images/life-of-pi-boat-tiger-wallpaper.jpg" onclick="insertImageToCanvas(this.src)" data-dismiss="modal">
                    <a href="https://free4kwallpapers.com/" class="text-secondary text small ml-2" target="_blank">View Image Source</a>
                  </div>
                  <div class="clearfix"></div>
                  <div class="card">
                    <img class="img-fluid card-img img-hover cursor-pointer" src="../images/templateImages/Nature%20images/high-resolution-nature-sky-background-12-widescreen-old-trees-green-nature-k-for-desktop-with-sky-wallpaper-high-resolution-pc-field-and-blue.jpg" onclick="insertImageToCanvas(this.src)" data-dismiss="modal">
                    <a href="https://free4kwallpapers.com/" class="text-secondary text small ml-2" target="_blank">View Image Source</a>
                  </div>
                  <div class="clearfix"></div>
                  <div class="card">
                    <img class="img-fluid card-img img-hover cursor-pointer" src="../images/templateImages/Video Game images/2623334-assassins-creed-movie-4k-image-of-best-wallpaper.jpg" onclick="insertImageToCanvas(this.src)" data-dismiss="modal">
                    <a href="https://free4kwallpapers.com/" class="text-secondary text small ml-2" target="_blank">View Image Source</a>
                  </div>
                  <div class="clearfix"></div>
