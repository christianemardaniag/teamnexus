<?php
  ...
  if (isset($_SESSION["current_user_email"]))
  {
    ...
    $query = "INSERT INTO `design_details`(`design_id`, `design_image`, `design_properties`) VALUES ((SELECT designid FROM design order by designid DESC LIMIT 1), (SELECT image FROM blinds where blinds_id = $blindsID), '$image_title')";
