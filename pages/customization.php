...
<head>
  ...
  <link type="text/css" href="../css/bootstrap-magnify.min.css" rel="stylesheet">
...
<body>
  ...
  <nav class="navbar navbar-dark bg-dark justify-content-between sticky-top">
    <span class="navbar-brand text-light">Adam Arc</span>
    <form class="form-inline">
      <input class="form-control form-control-sm mr-sm-2" type="search" value="Untitled Design" placeholder="Untitled Design" aria-label="Search" data-toggle="tooltip" title="Rename Design">
      <button class="btn btn-warning my-2 my-sm-0 btn-sm" type="button" onclick="addToCart()" data-toggle="tooltip" title="Add to Cart"><i class="fas fa-save"></i> Save</button>
    </form>
    <button class="btn btn-outline-secondary btn-sm" data-toggle="tooltip" title="Cancel Customization" role="button" onclick="window.open('home.php', '_self')">Cancel <i class="fas fa-arrow-right"></i></button>
  </nav>
          ...
          <div class="tab-pane fade show active" id="nav-blinds" role="tabpanel" aria-labelledby="nav-blinds-tab">
            <div class="container-fluid">
              <div class="row">
               <div class="col-sm-8 pt-2">
                ...
                <small class="text-secondary text-muted">If you change window blinds type all object that you created will be remove</small>
               </div>
            ...
            <div class="container mt-4 overflow-y">
              <div class="card-columns card-columns-2">
                <div class="card border border-primary" data-category="Roller Shades">
          ...
          <div class="tab-pane fade " id="nav-fabric" role="tabpanel" aria-labelledby="nav-fabric-tab">
            ...
            <div class="container mt-4 overflow-y">
              <div class="card-columns">
                <div class="card">
                  <img data-toggle="magnify" class="img-fluid cursor-pointer" src="../images/Fabrics/Dockside%20Brushed%20Bull%20Denim.jpg">
                  <div class="card-body">
                    <h6 class="card-title">Dockside Brushed Bull Denim</h6>
                    <button class="btn btn-warning btn-sm btn-block" onclick="changeFabric($(this).parent().parent().find('img').attr('src'))">Apply</button>
                  </div>
                </div>
                <div class="clearfix"></div>
                <div class="card">
                  <img data-toggle="magnify" class="img-fluid" src="../images/fabrics/Irish%20Linen.jpg">
                  <div class="card-body">
                ...
                <div class="clearfix"></div>
                <div class="card">
                  <img data-toggle="magnify" class="img-fluid" src="../images/fabrics/Sunbrella%20Canvas.jpg">
                  <div class="card-body">
...
-->
          ...
          <div class="tab-pane fade show" id="nav-properties" role="tabpanel" aria-labelledby="nav-properties-tab">
            <div class="container-fluid">
              <div class="row">
                <div class="col-sm-6">
                  <p class="lead pt-2">Upload your Image</p>
                  <input id="insert-image" type="file" class="dropify" data-height="80" data-width="50" data-allowed-file-extensions="png jpg" data-show-remove="false" data-max-file-size="1M" accept=".jpg, .png, .jpeg image/*" />
                </div>
                <div class="col-sm-6">
                  <p class="lead pt-2">Add Objects</p>
                  <div class="container-fluid">
                    <div class="row">
                      <button id="btnCircle" type="button" class="btn btn-link col-sm-6" data-toggle="tooltip" title="Insert Circle"><i class="fas fa-circle"></i> Circle</button>
                      <button class="btn btn-link col-sm-6" id="btnSquare" type="button" data-toggle="tooltip" title="Insert Square"><i class="fas fa-square"></i>  Square</button>
                      <button class="btn btn-link col-sm-6" id="btnLine" type="button" data-toggle="tooltip" title="Insert Line"><i class="fas fa-minus"></i> Line</button>
                      <button id="btnTriangle" class="btn btn-link col-sm-6" type="button" data-toggle="tooltip" title="Insert Triangle"><i class="fas fa-play" data-fa-transform="rotate-270"></i> Triangle</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="container mt-2">
              ...
              <!--              OBJECT PROPERTIES     -->
              <div id="object-properties" class="">
                <hr>
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="form-group row">
                    ...
                    <input type="text" readonly class="col-7 form-control-plaintext text-truncate" value="Roller Blinds" />
                    <label class="col-5 col-form-label">Fabric</label>
                    <input type="text" readonly class="col-7 form-control-plaintext text-truncate" value="Belgian Linen" />
                    ...
                    <button class="btn btn-warning btn-block" type="button"><i class="fas fa-save"></i>&nbsp;Save</button>
                  </div>
                </div>
                <div class="col-sm-6">
    ...
    <input type="checkbox" autocomplete="off"><i class="fas fa-hand-paper text-danger" text-danger></i>
  </label>
        </div>
        <button type="button" class="btn btn-light" data-toggle="tooltip" title="Insert Triangle"><i class="fas fa-sync"></i> Reset</button>
        <button type="button" class="btn btn-light" data-toggle="tooltip" title="Insert Triangle"><i class="fas fa-plaay text-danger"></i>Help</button>
      </div>
      <!--        CANVAS    -->
