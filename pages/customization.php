  ...
  ?>
        ...
        <div class="col-xl-6 col-lg-6 col-12">
          ...
          <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              <button class="btn-link nav-item nav-link active" id="step1" data-toggle="tab" href="#nav-blinds" role="tab" aria-controls="nav-blinds" aria-selected="true" onclick="step1()">Step 1</button>
              <button class="btn-link nav-item nav-link" id="step2" data-toggle="tab" href="#nav-fabric" role="tab" aria-controls="nav-fabric" aria-selected="false" disabled onclick="step2()">Step 2</button>
              <button class="btn-link nav-item nav-link" id="step3" data-toggle="tab" href="#nav-properties" role="tab" aria-controls="nav-properties" aria-selected="false" disabled onclick="step3()">Step 3</button>
              <button class="btn-link nav-item nav-link" id="step4" data-toggle="tab" href="#nav-myContent" role="tab" disabled onclick="step4()">Step 4</button>
            </div>
          </nav>

          <!--        NOTE STEP 1-->
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-blinds">
            ...
            <div class="tab-pane fade show" id="nav-properties">
              ...
              <div id="properties-opacity" class="form-inline row">
                ...
                <div class="col-4">
                  <input type="range" min="1" max="100" value="100" step="1" id="range-opacity" class="slider">
                </div>
                <div class="col-3">
                  <input type="number" value="100" min="1" max="100" step="1" id="number-opacity" class="form-control form-control-sm">
                </div>
              </div>
    ...
    <div class="col-xl-6 col-lg-6 col-12 d-print-none">
      <div class="btn-group" role="group">
        ...
        <button id="btnZoomOut" type="button" class="btn btn-light" data-toggle="tooltip" data-html="true" title="Zoom Out <br><kbd>Alt + Scroll down</kbd>" data-placement="top" disabled><i class="fas fa-search-minus"></i> <small class="d-none d-lg-inline">Zoom Out</small></button>

        <div class="btn-group-toggle" data-toggle="buttons">
          <label id="btnPan" class="btn btn-light disabled" data-toggle="tooltip" data-html="true" title="Move <br><kbd>Alt + Drag</kbd>" data-placement="top">
    <input type="checkbox" autocomplete="off"><i class="fas fa-hand-paper"></i> <small class="d-none d-lg-inline" >Move</small>
        ...
        <button id="btn-reset" type="button" class="btn btn-light" data-toggle="popover" data-html="true" data-placement="bottom" title="Reset Design" data-content="Are you sure you want to reset your design?<div class='container'><div class='row'><button class='col btn btn-sm btn-info' onclick=cancelReset()>Cancel</button><button class='col btn btn-sm btn-link text-secondary text-muted' onclick=reset()>Reset</button></div></div>"><i class="fas fa-sync"></i> <small class="d-none d-lg-inline">Reset</small></button>
        ...
        <button id="btnDelete" class="d-none btn btn-light text-danger" type="button" data-toggle="tooltip" data-placement="top" data-html="true" data-delay='{"show":"500", "hide":"300"}' title="Remove (<kbd>Delete</kbd>)"><i class="far fa-trash-alt"></i></button>
