...
//                            $row["userpass"];
                            ...
                            echo "<div class='card card-category'>";
                                ...
                                echo "<div class='card-footer'>";
                                   echo " <button id='btn-edit_" . $c . "' class='btn btn-warning btn_edit' data-toggle='modal' data-target='.bd-editFabric-modal'>Edit</button>";
                                   echo " <button id = 'btn-remove_" . $c . "' class='btn btn-warning float-right btn_remove'  data-toggle='popover' data-container='body'  data-trigger='focus' data-placement='top' data-html='true' >Remove</button>";
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <label for="FabricName"><b>Fabric No: </b></label>
                                <input type="text" name="fabricNo" id="fabricNo" class="form-control">
                            </div>
                            <div class="col-6">
                                <label for="FabricName"><b>Name: </b></label>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
          ...
          $("#chat_window_1").animate({
            ...
            $(".bd-addFabric-modal").on('hide.bs.modal', function(event) {
                $('#fabricName').val('');
