              ...
              <table class="table table-bordered table-responsive" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php
                                        ...
                                        $queryCateogry = "SELECT blinds.*, blinds_type_name, blinds_category.status FROM blinds,blinds_category WHERE blinds.blinds_category_id = blinds_category.blinds_category_id AND blinds_category.status = 'available'";
                                        ...
                                        echo "<tr>";
                                            ...
                                            echo "<td class= 'category_name'>" . $row['blinds_type_name'] . "</td>";
                                            ...
                                            echo "<td class='dbDesc truncate'> " . $desc . " </td>";
...
//                                            echo "<td>" . $desc . "</td>";
                                            ...
                                            echo "<td class='text-center'><a href='#' id='dropdownMenuButton1' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>&nbsp;<i class='fas fa-ellipsis-h'></i></a>
                                                <div class='dropdown-menu' aria-labelledby='dropdownMenuButton'>
                                                    ...
                                                    <a class='dropdown-item text-danger removeBlinds' id = 'removeBlinds' href='#'><i class='fas fa-trash-alt'></i> Delete</a>
    ...
    <form action="deleteBlinds.php" name="deleteForm" method="post">
      <input type="hidden" name="deleteBlinds" id="deleteBlinds">
      <input type="hidden" name="action" value="deleteBlinds">
    </form>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="min-height: calc(100vh - 210px); overflow-y: auto">
                ...
                <div class="col-12 col-sm-12 col-xl-6">
                  ...
                  <div class="row">
                      ...
                      <select class="form-control" id="dbaddBlindsCategory" name="dbaddBlindsCategory">
                                            ...
                                            <?php
                                                ...
                                                while($row = mysqli_fetch_array($resultCategory)){
                                                    ...
                                                    echo "<option class='dbCat' id =dbCat_" . $ca . " value=" .$row['blinds_category_id'] . ">" . $row['blinds_type_name'] . "</option>";
                                                   $ca++; 
                                                }
                    ...
                    <div class="col-9 mt-3">
                      <textarea class="form-control" id="dbDescription" name="dbDescription" rows="9"></textarea>
                    </div>
                  ...
                  <div class="row p-3">
                    <div class="col-10 m-2">
                      ...
                      <div class="custom-file">
                        ...
                        <input type="hidden" name="action" value="editBlinds">
                        <input type="hidden" name="category_name" name="category_name">
              ...
              <div class="modal-footer">
                <button class="btn btn-warning" id="saveEditBlinds" disabled><i class="fas fa-edit"></i> Save</button>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $("#viewblindFile, #dbDescription, #dbaddBlindsCategory, #dbblindsName").change(function() {
        $('#saveEditBlinds').removeAttr("disabled");
      });

      $("#saveEditBlinds").click(function() {
      ...
      $('.filter_inset').click(function() {
        ...
        $id = $(this).closest("tr").find(".blinds_id").html();
        ...
        $category_name = $(this).closest("tr").find(".category_name").html();

        $a = $("select option:contains(" + $category_name + ")").attr('id');

        $('.dbaddBlindsCategory #' + $a).attr('selected');
