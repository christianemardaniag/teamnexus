...
//                            $query = "SELECT tbl_postimage.*, post.caption, post.date_posted FROM tbl_postimage,post WHERE tbl_postimage.postImg_id = post.postid";
                             ...
                             while($row = mysqli_fetch_array($result)){
                                 ...
                                 echo "<div class='col-md-3 col-sm-4 col-xs-6'><a title='" . $dbImg . "' href='#'><img style='height:280px;' class='img-gallery' id = '" . $post_id . "' style= 'object-fit: cover' width = '300' height='350' src='" . $dbImg . "' /></a></div>";
          ...
          <div class="modal-dialog modal-dialog-centered modal-lg">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="container-fluid" id="modalGallery-container">


                  <!--                                    <div class="row">-->
                  <!--                                   col-xl-7 col-lg-7 col-md-7 col-sm-12 col-7-->
                  <!--
                                     <div class='col-md-3 col-sm-4 col-xs-6 mb-2'>
                                            <img src="images/RollerBlinds/Benefits-of-Roller-Blinds-480x480.jpg" width="200" alt="img1" class="img-fluid" id="modal-Gallery" style="object-fit:cover">
                                        </div>
-->
                  <!--                                    </div>-->
                </div>
              ...
              <div class="modal-footer">
                <button value="edit" name="action" class="btn btn-primary text-light btn_edit"><i class="fa fa-edit"></i>&nbsp;Edit Caption</button>
                <button id='removePost' name="action" class="btn btn-danger text-light"><i class="fa fa-trash-alt"></i>&nbsp;Delete Post</button>
              </div>
            </div>
          </div>
        </form>
        ...
        $(document).ready(function() {
          ...
          $(function() {
            $('.img-gallery').on('click', function() {
              ...
              $(".btn_save").removeAttr("class", "btn_save").attr("class", 'btn btn-primary text-light btn_edit');
              $("textarea:disabled").css("border", "none").attr("disabled", "disabled");
              $(".btn_edit").html("<i class='fa fa-edit'></i>&nbsp;Edit Caption")

              $('#myModal-gallery').modal('show');

              //pass id to displayModalmages.php
              $.ajax({
                type: "GET",
                url: "displayModalImages_Gallery.php",
                dataType: "text",
                data: {
                  "post_id": $post_id
                ...
                success: function(data) {
                  ...
                  $("#modalGallery-container").html(data);
          ...
          $(".btn_edit").on("click", function() {
            ...
            $("textarea:disabled").css("border", "1px solid #cccccc").removeAttr("disabled").keypress(function() {
              $(".btn_edit").removeAttr('class', 'btn_edit').attr('class', 'btn btn-primary text-light btn_save');
              $(".btn_save").empty();
