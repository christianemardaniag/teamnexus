...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="row fixed-position">
      <div class="col-3" id="inboxContainer">
        <ul class="list-group" id="inbox">
          ...
          <?php
                    ...
                    $query = "select feedback.*, concat(firstname,' ',lastname) as 'fullname' from feedback, customer where feedback.email = customer.email";
                    $res = $dbQ->query($query);
                  
                    while($row = mysqli_fetch_array($res))
                    {
                      echo "<li class='list-group-item fblist' id='feedbackMessCont' data-email = '".$row['email']."'>
                        <a class='dropdown-item' href='#'>
                              <strong>".$row['fullname']."</strong>
                              <span class='small float-right text-muted'>".$row['feedback_date']."</span>
                              <div class='dropdown-message small text-truncate'>".$row['message']."</div>
                            </a>
                          </li>";
                    }
      ...
      <div class="col-9" data="0" id="messageCreate">
        <div class="col-6">
          <div class="input-group mb-2">
            <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon1"><a href="#" class="text-dark">To</a></span>
            </div>
            <input type="text" class="form-control" placeholder="Recepients" aria-label="Username" aria-describedby="basic-addon1" id="txtEmail" />
          </div>

          <div class="input-group mb-3">

            <input type="text" class="form-control" placeholder="Subject" aria-label="Subject" aria-describedby="basic-addon1" id = "txtSubject">
          </div>
        </div>
        <div class="col-12">
          ...
          <div class="float-right">
            <button class="btn btn-primary" id="btnSend"><i class="fas fa-envelope"></i> Send</button>
...
-->
  ...
  <script src="C:/xampp/htdocs/admin/vendor/jquery/jquery.js" type="text/javascript"></script>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $("#btnSend").click(function(){
            ...
            var txtmessage = "|sdafsdfasdfasdf"; //$('div#froala-editor').froalaEditor('html.get');
